...
<head>
    ...
    <style>
        body {
            ...
            padding: 0;
            color: #333;
						background-image: url('img/slides/form_bg.jpg');
...
<div class="container">
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $treeType = htmlspecialchars($_POST['tree-type']);
        $message = htmlspecialchars($_POST['message']);

        echo "<div class='summary'>";
        echo "<p><strong>Vaše meno:</strong> $name</p>";
        echo "<p><strong>Vaš email:</strong> $email</p>";
        echo "<p><strong>Miesto pristátia:</strong> $location</p>";
        echo "<p><strong>Typ stromu:</strong> $treeType</p>";
        ...
        echo "<a href='form.html' class='btn'>Späť na formulár</a>";
    }
    ?>
